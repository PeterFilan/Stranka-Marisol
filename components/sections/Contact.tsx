        ...
        <section id="contact" className="section-padding bg-white">
            <div className="container mx-auto">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
                    ...
                    <div className="space-y-8">
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                            <a
                                ...
                                target="_blank"
                                className="flex items-center gap-4 p-6 bg-green-50 text-green-700 hover:bg-green-100 transition-all border border-green-100 group"
                            >
                            ...
                            <a
                                ...
                                target="_blank"
                                className="flex items-center gap-4 p-6 bg-blue-50 text-blue-700 hover:bg-blue-100 transition-all border border-blue-100 group"
                            >
                            ...
                            <a
                                ...
                                target="_blank"
                                className="flex items-center gap-4 p-6 bg-pink-50 text-pink-700 hover:bg-pink-100 transition-all border border-pink-100 group"
                            >
                    ...
                    <div className="space-y-8">
                        ...
                        <div className="bg-accent/10 p-8 border border-accent/30">
                            <div className="flex items-start">
                                ...
                                <div className="ml-4">
                                    <h3 className="font-bold text-gray-900 uppercase tracking-widest">{t("address")}</h3>
                            ...
                            <div className="flex items-start mt-4">
                                ...
                                <div className="ml-4">
                                    <h3 className="font-bold text-gray-900 uppercase tracking-widest">{t("phone")}</h3>
                            ...
                            <div className="flex items-start mt-4">
                                ...
                                <div className="ml-4">
                                    <h3 className="font-bold text-gray-900 uppercase tracking-widest">{t("email")}</h3>
                    ...
                    <div className="h-96 bg-gray-200 overflow-hidden shadow-lg">
                        <iframe
